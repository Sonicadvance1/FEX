...
namespace {
  ...
  constexpr static std::array<LastAccessType, 17> DefaultAccess = {
    ACCESS_NONE,
    ACCESS_NONE,
    ACCESS_INVALID, // PAD
    ACCESS_NONE,
  ...
  static void ClassifyContextStruct(ContextInfo *ContextClassificationInfo) {
    ...
    ContextClassification->emplace_back(ContextMemberInfo {
      ContextMemberClassification {
        offsetof(FEXCore::Core::CPUState, MXCSR),
        sizeof(FEXCore::Core::CPUState::MXCSR),
      },
      DefaultAccess[16],
      FEXCore::IR::InvalidClass,
    });
  ...
  static void ResetClassificationAccesses(ContextInfo *ContextClassificationInfo) {
    ...
    SetAccess(Offset++, DefaultAccess[16]);
  }
