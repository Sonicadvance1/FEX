...
namespace FEXCore::Context {
  ...
  class Context {
    public:
       ...
       */
      FEX_DEFAULT_VISIBILITY virtual uint32_t ReconstructCompactedEFLAGS(FEXCore::Core::InternalThreadState *Thread, bool WasInJIT, uint64_t const *HostGPRs, uint64_t PSTATE) = 0;
